...
const NewHouseRefinancePage = () => {
  const navigate = useNavigate();
  const [menuOpen, setMenuOpen] = useState(false);

const loan = {
  slug: 'refinance',
  name: 'New House Refinance Loan',
  icon: '🏠',
  description:
    'Refinance your existing home loan to enjoy lower interest rates and improved repayment flexibility.',
  rate: '8.50',
  maxAmount: '₹10 Crore',
  ...
  eligibility: [
    'Age 21–65 years',
    'Existing home loan with regular repayment history',
    'Good credit score',
...
export default NewHouseRefinancePage;