...
export const LOAN_CATEGORIES = [
  {
    ...
    subLoans: [
      { label: 'Home Loan',                 href: '#', desc: 'Buy your dream home' },
      { label: 'Loan Against Property',     href: '#', desc: 'Unlock your property value' },
      { label: 'Mortgage Loan',             href: '#', desc: 'Secured long-term finance' },
      { label: 'Site Purchase Loan',        href: '#', desc: 'Buy a plot to build on' },
      { label: 'Balance Transfer & Top-Up', href: '#', desc: 'Switch & save on interest' },
      { label: 'New House Refinance',       href: '#', desc: 'Refinance at better rates' },
      { label: 'House Purchase Loan',       href: '#', desc: 'Ready-to-move homes' },
      { label: 'Construction Loan',         href: '#', desc: 'Build stage by stage' },
      { label: 'Mixed Usage Property Loan', href: '#', desc: 'Commercial + residential' },
    ],
    calculators: [
  ...
  },
  {
    ...
    subLoans: [
      { label: 'Secured Business Loan',    href: '#', desc: 'Collateral-backed funding' },
      { label: 'Unsecured Business Loan',  href: '#', desc: 'No collateral needed' },
      { label: 'Working Capital Loan',     href: '#', desc: 'Keep operations running' },
      { label: 'Business Expansion Loan',  href: '#', desc: 'Scale up confidently' },
    ],
    calculators: [
