...
export const LOAN_CATEGORIES = [
  ...
  },
  {
    ...
    subLoans: [
      { label: 'Secured Business Loan',   href: '/business-loan/secured-business-loan',   desc: 'Collateral-backed funding' },
      { label: 'Unsecured Business Loan', href: '/business-loan/unsecured-business-loan',  desc: 'No collateral needed' },
      { label: 'Working Capital Loan',    href: '/business-loan/working-capital-loan',     desc: 'Keep operations running' },
      { label: 'Business Expansion Loan', href: '/business-loan/business-expansion-loan', desc: 'Scale up confidently' },
    ],
    calculators: [
